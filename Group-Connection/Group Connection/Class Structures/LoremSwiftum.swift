...
fileprivate extension Lorem {
    ...
    fileprivate static let allWords: [String] = """
            evaluate approach election contrast mushroom offender consider theorist specimen portrait ignorant sentence vertical familiar frighten platform magazine behavior casualty definite exchange business marathon implicit rational interest helpless argument motorist variable calendar audience medicine multiply property decisive concrete superior language aviation forecast amputate pleasure survivor attitude constant straight friendly advocate discover collapse position discount break-in minimize reliance hesitate ambition confront buttocks shortage sandwich football division software national detector separate accident pressure crackpot conflict occasion resource profound disorder baseball fragrant abstract movement bulletin fraction dominate feminine pleasant spectrum producer invasion research skeleton medieval observer organize traction hardware ministry distance consumer cucumber seasonal unlawful appetite estimate elephant nonsense exercise absolute mountain abnormal teenager mistreat orthodox suitcase security minister gradient district ancestor restrain magnetic disclose practice indirect umbrella mosquito grateful illusion appendix commerce contract overlook exposure abortion majority tropical domestic minority affinity conceive cassette unlikely dominant patience engineer activate romantic criminal adoption flatware activity negative necklace weakness critical reliable analysis emphasis parallel work-out slippery epicalyx dividend handicap restless wear-out greeting momentum customer freshman champion withdraw incident addition forestry cylinder finished industry misplace material category designer opposite prisoner overview delivery describe hardship graduate monopoly response survival dedicate distinct fragment threaten transfer delicate dressing vigorous document identity
            """.components(separatedBy: " ")
    
    fileprivate static let firstNames = """
    ...
    fileprivate static let lastNames = """
    ...
    fileprivate static let emailDomains = """
    ...
    fileprivate static let urlDomains = """
